...
* synchronized属于JVM层面，它是Java的关键字
* lock属于API层面，它Java5以后新发生的一个类
* 1. 原始构成
...
*
* 5. 锁绑定多个条件Condition（使用新的lock的好处）
*   synchronized 没有
*   ReentrantLock 用来实现分组唤醒"需要唤醒的线程们"，可以精确唤醒，而不是像synchronized要么随机唤醒一个线程要么唤醒全部线程
*
* ===================================================================================================
* ===================================================================================================
* ===================================================================================================
